...
@inject('uiStore')
@observer
class DeleteAccountModalScreen extends Component {
  render() {
    return (
      <Modal
        animationType="fade"
        transparent
        visible={
          this.props.uiStore.modal.open && this.props.uiStore.modal.type === 'delete account'
        }
...
export default DeleteAccountModalScreen;
