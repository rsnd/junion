...
class SettingsEventConversationsScreen extends Component {
  constructor(props) {
    super(props);
    this.state = {
      panelCollapsed: true,
              ...
              <View style={eventStyles.messageBoxContainer}>
                ...
                <Collapsible collapsed={this.checkCollapsed(num)}>
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => this.props.navigation.navigate('SettingsEventResponses')}
                  >
                    <View style={{
                        alignItems: 'center',
...
export default SettingsEventConversationsScreen;
